<iconic-header>
    ...
    <style scoped>
        ...
        :scope .brand { float: left; display: block; margin-top: 0.8rem; margin-left:1rem; }
        ...
        :scope div > ul { margin: 0; padding: 0; float: right; }
        :scope div > ul li { list-style: none; margin: 0; padding: 0; }
        :scope div > ul.u-pull-right li { padding-right: 0.5rem; }
