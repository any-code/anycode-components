...
riot.tag2('iconic-footer', '<article class="u-pn"> <div class="row"> <div class="three columns badge"> <yield from="badge"></yield> </div> <div class="six columns links"> <yield from="links"></yield> </div> <div class="three columns social"> <yield from="social"></yield> </div> </div> <article> <iconic-tip position="below" delay="1" name="links-tip" class="links-tip"></iconic-tip>', 'iconic-footer,[riot-tag="iconic-footer"] { display: block; position: relative; margin: 0; padding: 0; height: auto; transition: all 200ms ease-in-out; left: 0; right: 0; height: 4.2rem; white-space: nowrap; height: 22rem; } iconic-footer .badge,[riot-tag="iconic-footer"] .badge,iconic-footer .links,[riot-tag="iconic-footer"] .links,iconic-footer .social,[riot-tag="iconic-footer"] .social { height: 10rem; margin-top: 5rem; text-align:center; } iconic-footer.shrink,[riot-tag="iconic-footer"].shrink { padding: 0 1rem 0 4rem; height: auto; position: relative; clear: both; } iconic-footer.shrink ul,[riot-tag="iconic-footer"].shrink ul { text-align: center; } iconic-footer .links > ul,[riot-tag="iconic-footer"] .links > ul { margin: 3.8rem 0 0 0; padding: 0; text-align: center; } iconic-footer .links > ul li,[riot-tag="iconic-footer"] .links > ul li { padding: 0; margin: 0; list-style: none; display: inline-block; padding-right: 0.5rem; } iconic-footer.shrink .links > ul li,[riot-tag="iconic-footer"].shrink .links > ul li { display: block; padding-left:1rem; padding-right: 1rem; } iconic-footer.shrink .links > ul li a,[riot-tag="iconic-footer"].shrink .links > ul li a { padding-left:1rem; } iconic-footer.shrink .links > ul li a.button,[riot-tag="iconic-footer"].shrink .links > ul li a.button { display: block; margin: 1rem 0 0 1rem; } iconic-footer .links > ul li a,[riot-tag="iconic-footer"] .links > ul li a { font-size: 1.1rem; font-weight: 300; text-transform: uppercase; color: rgba(0, 0, 0, 0.7); text-align: left; display: block; padding: 0.8rem; transition: all 80ms ease-in-out; text-decoration: none; } iconic-footer .links > ul li a.button,[riot-tag="iconic-footer"] .links > ul li a.button { vertical-align: middle; } iconic-footer .links > ul li.separator,[riot-tag="iconic-footer"] .links > ul li.separator { height: 0; border-left: 6px solid white; } iconic-footer .links > ul li ul,[riot-tag="iconic-footer"] .links > ul li ul { padding: 0; margin: 0; } iconic-footer .links > ul li ul li,[riot-tag="iconic-footer"] .links > ul li ul li { padding: 0; margin: 0; list-style: none; } iconic-footer .links > ul li ul li a,[riot-tag="iconic-footer"] .links > ul li ul li a { font-size: 1rem; display: block; padding: 0.1rem 0.1rem 0.1rem 2rem; -webkit-transition: .5s all ease-out; -moz-transition: .5s all ease-out; transition: .5s all ease-out; text-decoration: none; } iconic-footer .icon-anycode-badge,[riot-tag="iconic-footer"] .icon-anycode-badge { font-size: 8rem; }', 'class="{shrink: shrink}"', function(opts) {
